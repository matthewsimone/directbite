  ...
  try {
    ...
    switch (event.type) {
      case "payment_intent.succeeded": {
        ...
        // ---- Scheduled uber_direct orders are NOT booked here ----
        // Uber is called only when the restaurant Accepts on the tablet
        // (uber-create-delivery with pickup_ready_dt = scheduled_for). Booking at
        // placement was removed so a restaurant can switch to in-house before
        // accepting without the customer getting an Uber "delivery canceled" text.
        // Order lands 'new' with uber_delivery_id null; the tablet scheduled-Accept
        // path books it.
